...
#define NEPTUNE_PROFILE_ZONE                                              ZoneScoped
#define NEPTUNE_PROFILE_ZONEN(...)                                        ZoneScopedN(__VA_ARGS__)
...
#define NEPTUNE_PROFILE_MARK(...)                                         TracyMessageL(__VA_ARGS__)
#define NEPTUNE_PROFILE_IMAGE(...)                                        FrameImage(__VA_ARGS__)

#define NEPTUNE_PROFILE_VK_CONTEXHOSTCALIBRATED(pd, d, qr, ctd, ct)       //TracyVkContextHostCalibrated(pd, d, qr, ctd, ct)
#define NEPTUNE_PROFILE_VK_DESTROY                                        //TracyVkDestroy(TracyGPUContext::Get().GetContext())
#define NEPTUNE_PROFILE_VK_CONTEXTNAME(ctx, name, size)                   //TracyVkContextName(ctx, name, size)
...
#define NEPTUNE_PROFILE_MARK(...)
#define NEPTUNE_PROFILE_IMAGE(...)

#define NEPTUNE_PROFILE_VK_CONTEXHOSTCALIBRATED(pd, d, qr, ctd, ct)
#define NEPTUNE_PROFILE_VK_DESTROY
#define NEPTUNE_PROFILE_VK_CONTEXTNAME(ctx, name, size)
