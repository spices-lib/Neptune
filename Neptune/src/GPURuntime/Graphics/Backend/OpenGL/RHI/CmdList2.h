...
#include "Core/Core.h"
#include "GPURuntime/Graphics/Backend/OpenGL/Infrastructure/Infrastructure.h"
#include "GPURuntime/Graphics/Frontend/RHI/CmdList2.h"
#include "CmdList.h"

namespace Neptune::OpenGL {

	/**
	* @brief OpenGL::CmdList2 Class.
	* This class defines the OpenGL::CmdList2 behaves.
	*/
