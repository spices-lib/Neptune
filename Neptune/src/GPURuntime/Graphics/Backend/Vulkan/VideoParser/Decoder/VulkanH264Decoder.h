...
#define MAX_MMCOS        72  // maximum number of mmco's
    ...
    struct seq_parameter_set_s : public StdVideoPictureParametersSet, public StdVideoH264SequenceParameterSet
    {
        ...
        seq_parameter_set_s(uint64_t updateSequenceCount)
            : StdVideoPictureParametersSet(StdType::TYPE_H264_SPS, ParameterType::SPS_TYPE, updateSequenceCount)
        ...
        virtual ~seq_parameter_set_s() = default;

        static SP<seq_parameter_set_s> Create(uint64_t updateSequenceCount)
        {
            return CreateSP<seq_parameter_set_s>(updateSequenceCount);
        }
    ...
    struct pic_parameter_set_s : public StdVideoPictureParametersSet, public StdVideoH264PictureParameterSet
    {
        ...
        pic_parameter_set_s(uint64_t updateSequenceCount)
            : StdVideoPictureParametersSet(StdType::TYPE_H264_PPS, ParameterType::PPS_TYPE, updateSequenceCount)
        ...
        virtual ~pic_parameter_set_s() = default;

        static SP<pic_parameter_set_s> Create(uint64_t updateSequenceCount)
        {
            return CreateSP<pic_parameter_set_s>(updateSequenceCount);
        }
    ...
    private:
        ...
        void dpb_picture_start(SP<pic_parameter_set_s> pps, slice_header_s* slh);
        ...
        void update_layer_info(SP<seq_parameter_set_s> sps, SP<pic_parameter_set_s> pps, slice_header_s* slh);
    ...
    private:
        ...
        SP<seq_parameter_set_s> m_sps;  // active sps
        SP<pic_parameter_set_s> m_pps;  // active pps
        seq_parameter_set_mvc_extension_s* m_spsme; // active spsme
        SP<seq_parameter_set_s> m_spss[MAX_NUM_SPS];
        seq_parameter_set_mvc_extension_s* m_spsmes[MAX_NUM_SPS];
        SP<seq_parameter_set_s> m_spssvcs[MAX_NUM_SPS];
        SP<pic_parameter_set_s> m_ppss[MAX_NUM_PPS];
