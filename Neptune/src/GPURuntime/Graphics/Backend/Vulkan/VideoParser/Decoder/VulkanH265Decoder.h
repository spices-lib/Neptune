...
#include "GPURuntime/Graphics/Backend/Vulkan/VideoParser/STD/StdVideoPictureParametersSet.h"
#include "VulkanVideoDecoder.h"
#include "GPURuntime/Graphics/Backend/Vulkan/VideoParser/STD/nvVulkanh265ScalingList.h"
...
#define VK_H265_SPS_VUI_FLAG(pStdVui, nvSpsIn, name) pStdVui->flags.name = nvSpsIn->vui.name
    ...
    struct hevc_seq_param_s : public StdVideoPictureParametersSet, public StdVideoH265SequenceParameterSet
    {
        ...
        const StdVideoH265SequenceParameterSet* GetStdH265Sps() const override { return this; }
        ...
        hevc_seq_param_s(uint64_t updateSequenceCount)
            : StdVideoPictureParametersSet(StdType::TYPE_H265_SPS, ParameterType::SPS_TYPE, updateSequenceCount)
        ...
        ~hevc_seq_param_s() override = default;

        static std::shared_ptr<hevc_seq_param_s> Create(uint64_t updateSequenceCount)
        {
            return std::make_shared<hevc_seq_param_s>(updateSequenceCount);
        }
    ...
    struct hevc_pic_param_s : public StdVideoPictureParametersSet, public StdVideoH265PictureParameterSet
    {
        hevc_pic_param_s(uint64_t updateSequenceCount)
            : StdVideoPictureParametersSet(StdType::TYPE_H265_PPS, ParameterType::PPS_TYPE, updateSequenceCount)
            , StdVideoH265PictureParameterSet()
            , stdScalingLists()
            , pps_scaling_list() {
        }

        ~hevc_pic_param_s() override = default;

        static std::shared_ptr<hevc_pic_param_s> Create(uint64_t updateSequenceCount)
        {
            return std::make_shared<hevc_pic_param_s>(updateSequenceCount);
        }
        ...
        const StdVideoH265PictureParameterSet* GetStdH265Pps() const override { return this; }
    ...
    struct hevc_video_param_s : public StdVideoPictureParametersSet, public StdVideoH265VideoParameterSet
    {
        ...
        hevc_video_param_s(uint64_t updateSequenceCount)
            : StdVideoPictureParametersSet(StdType::TYPE_H265_VPS, ParameterType::VPS_TYPE, updateSequenceCount)
        ...
        ~hevc_video_param_s() override = default;

        static std::shared_ptr<hevc_video_param_s> Create(uint64_t updateSequenceCount)
        {
            return std::make_shared<hevc_video_param_s>(updateSequenceCount);
        }
        ...
        const StdVideoH265VideoParameterSet* GetStdH265Vps() const override { return this; }
    ...
    public:
        ...
        bool GetDisplayMasteringInfo(VkParserDisplayMasteringInfo*) override;
    ...
    protected:
        ...
        struct H265ParserData
        {
            ...
            virtual ~H265ParserData() = default;
    ...
    protected:
        ...
        // DPB management
        bool dpb_sequence_start(std::shared_ptr<hevc_seq_param_s>& sps);
        ...
        void dpb_picture_start(std::shared_ptr<hevc_pic_param_s>& pps, hevc_slice_header_s* slh);
    ...
    protected:
        ...
        std::shared_ptr<hevc_seq_param_s> m_active_sps[MAX_VPS_LAYERS];
        std::shared_ptr<hevc_pic_param_s> m_active_pps[MAX_VPS_LAYERS];
        std::shared_ptr<hevc_video_param_s> m_active_vps;
        std::shared_ptr<hevc_seq_param_s> m_spss[MAX_NUM_SPS];
        std::shared_ptr<hevc_pic_param_s> m_ppss[MAX_NUM_PPS];
        std::shared_ptr<hevc_video_param_s> m_vpss[MAX_NUM_VPS];
