...
#include "GPURuntime/Graphics/Backend/Vulkan/VideoParser/PictureBufferBase.h"
#include "GPURuntime/Graphics/Backend/Vulkan/VideoParser/STD/StdVideoPictureParametersSet.h"
#include "GPURuntime/Graphics/Backend/Vulkan/Resource/DecodeBuffer.h"
#include "GPURuntime/Graphics/Backend/Vulkan/VideoParser/ClientDelegate.h"
...
#define VK_MAX_SEQ_HDR_LEN (1024)  // 1024 bytes
    ...
    public:
        ...
        // ready to be decoded
        virtual bool UpdatePictureParameters(std::shared_ptr<StdVideoPictureParametersSet>& pictureParametersObject,  // IN
            std::shared_ptr<void*>& client)                            // OUT
...
// If set, Picture Parameters are going to be provided via UpdatePictureParameters callback
    ...
    public:
        ...
        virtual ~VulkanVideoDecodeParser() = default;

        virtual void Initialize(const VkParserInitDecodeParameters* pParserPictureData) = 0;
