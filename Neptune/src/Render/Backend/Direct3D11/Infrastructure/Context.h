...
namespace Neptune::Direct3D11 {
    ...
    */
    ...
    inline void Context::Registry(Args&&... args)
    {
        ...
        {
            NEPTUNE_CORE_ERROR("Direct3D11 Infrastructure Already Registered.")
    ...
    inline void Context::UnRegistry()
    {
        ...
        if (!m_Infrastructures[position])
        {
            NEPTUNE_CORE_ERROR("Direct3D11 Infrastructure is not registered yet, can not be unregisted.")
    ...
    I::T* Context::Get()
    {
        ...
        if (!m_Infrastructures[position])
        {
            NEPTUNE_CORE_ERROR("Direct3D11 Infrastructure is not registered yet, can not be got.")
