...
#include "Core/Core.h"
#include "Render/Backend/Direct3D11/Infrastructure/Infrastructure.h"
...
namespace Neptune::Direct3D11 {
	...
	/**
	* @brief Direct3D11::DescriptorList Class.
	* This class defines the Direct3D11::DescriptorList behaves.
	*/
