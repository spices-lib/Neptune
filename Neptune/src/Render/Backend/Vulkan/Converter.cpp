#include "Pchheader.h"
#include "Converter.h"
#include "Video\FFmpeg\Converter.h"
...
namespace Neptune::Vulkan {
	...
	VkShaderStageFlagBits ToVkShaderStageFlagBits(ShaderStage s)
	{
		...
		default:
		{
			CORE_WARN("Unsupported ShaderStage To VkShaderStageFlagBits.")
	...
	VkAttachmentLoadOp ToVkAttachmentLoadOp(AttachmentOP op)
	{
		...
		default:
		{
			CORE_WARN("Unsupported AttachmentOP To VkAttachmentLoadOp.")
	...
	VkImageLayout ToVkImageLayout(AttachmentLayout l)
	{
		...
		default:
		{
			CORE_WARN("Unsupported AttachmentLayout To VkImageLayout.")
	...
	TextureFormat ToTextureFormat(VkFormat f)
	{
		...
		default:
		{
			CORE_WARN("Unsupported VkFormat To Texture Format.")
