...
#define CHECK_FIELD(f)                        \
    do {                                      \
        ...
        explicit av1_seq_param_s(uint64_t updateSequenceCount)
            : StdVideoPictureParametersSet(StdType::TYPE_AV1_SPS, ParameterType::AV1_SPS_TYPE, updateSequenceCount),
        ...
        ~av1_seq_param_s() override = default;

        static SP<av1_seq_param_s> Create(uint64_t updateSequenceCount)
        {
            return CreateSP<av1_seq_param_s>(updateSequenceCount);
        }
    };
    ...
    protected:
        SP<av1_seq_param_s> m_sps;  // active sps
